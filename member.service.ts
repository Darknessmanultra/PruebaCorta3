...
export class MemberService {
  ...
  /**
   * Update a member
   * @param createMember - The member to change
   * @returns Observable<Member> - An observable of the created member
   */
  updateMember(createMember: CreateMember): Observable<Member> {
    
    return this.http.put<Member>(this.baseUrl + '/member',createMember);
  }
}
